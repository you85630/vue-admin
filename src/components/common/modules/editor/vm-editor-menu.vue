...
export default {
  ...
  components: {
    ...
    VmEditorDropdown: () => import('./vm-editor-dropdown.vue'),
    VmEditorAddlink: () => import('./vm-editor-addlink.vue'),
    VmEditorAddimage: () => import('./vm-editor-addimage.vue'),
    VmEditorFontcolor: () => import('./vm-editor-fontcolor.vue')
  },
  methods: {
